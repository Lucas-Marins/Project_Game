...
const CreateRecord = () =>{
    ...
    const handleSubmit = () =>{
        const paylod = {name,age,gameId: selectedGame};

        axios.post(`${BASE_URL}/records`, paylod)
            .then(()=>{
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <TextInput style={styles.inputText} placeholder="Idade" placeholderTextColor="#9E9E9E" keyboardType="numeric" maxLength={2} onChangeText={text =>setAge(text)} value={age}/>
